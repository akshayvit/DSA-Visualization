  ...
  const [removeValue,setRemoveValue]=useState(0);
    const {ref,insert,remove}=useBinarySearchTree();
        return (
            ...
            <>
              <div style={{width:'100%'}} className='container-fluid justify-content-center bg-primary'>
              <input 
            ...
            <button className='bg-danger' onClick={() => remove(removeValue)}>Remove</button>
              ...
              <GridLines className="grid-area" cellWidth={60} strokeWidth={2} cellWidth2={12}>
                ...
                <BinarySearchTree treeStyles={{lineColor:'red',lineHoverColor:'orange',nodeFontColor:'white',nodeNullFontColor:'green',nodeBorder:'4px solid red',nodeBackgroundColor:'green',nodeShadow:'rgba(50, 50, 93, 0.25) 0px 50px 100px -20px, rgba(0, 0, 0, 0.3) 0px 30px 60px -30px, rgba(10, 37, 64, 0.35) 0px -2px 6px 0px inset;',nodeHoverBackgroundColor:'blue',nodeHoverBorder:'pink'}} data={[1]} ref={ref}/>
